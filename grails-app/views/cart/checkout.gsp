...
<div class="section">
    ...
    <div class="container">
        <!-- row -->
        <div class="row">
            <g:form controller="user" action="mailSend" id="checkout-form" class="clearfix">
                <div class="col-md-6">
                ...
                <div class="col-md-12">
                    <div class="order-summary clearfix">
                        ...
                        <table class="shopping-cart-table table">
                            ...
                            %{--for total cost of carted product--}%
                            ...
                            <tr>
                                ...
                                <th>SUBTOTAL</th>
                                <th colspan="2" class="sub-total">$${sumTotal}</th>
                            </tr>
                            <tr>
                                <th class="empty" colspan="3"></th>
                                <th>SHIPING</th>
                            ...
                            <tr>
                                <th class="empty" colspan="3"></th>
                                <th>TOTAL</th>
                                <th colspan="2" class="total">$${sumTotal}</th>
                            </tr>
                            </tfoot>
                        </table>
                        <div class="pull-right">
                            <g:submitButton name="Place Order" class="primary-btn"></g:submitButton>
                        </div>
                    </div>
