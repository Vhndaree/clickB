	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<li class="fieldcontain">
					<span id="contact-label" class="property-label"><g:message code="user.contact.label" default="Contact" /></span>
					
						<span class="property-value" aria-labelledby="contact-label"><g:fieldValue bean="${userInstance}" field="contact"/></span>
